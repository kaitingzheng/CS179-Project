...
int main() {
    ...
    main->newShip("../sample_manifest/ShipCase5.txt"); // change this part to test different ship cases
	...
	cout << "Amount of container moves: " << state.containerMoveOrder.size() << endl;
	delete main;
    return 0;
}
